      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-slate-600 mb-4 text-pretty max-w-2xl mx-auto">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Built for Tamil Excellence</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                ...
                <span className="font-bold text-xl text-foreground">TLM 1.0</span>
              </div>
              <p className="text-sm text-slate-600 mb-4">
                Advanced Tamil Language Model built with cutting-edge AI technology for the Tamil community.
              </p>
            </div>
            ...
            <div className="text-center md:text-right">
              ...
              <div className="flex justify-center md:justify-end gap-3 mb-4">
                <a
                  ...
                  className="w-10 h-10 bg-muted hover:bg-primary/10 rounded-lg flex items-center justify-center transition-colors"
                >
                  <Facebook className="w-5 h-5 text-slate-600 hover:text-primary" />
                </a>
                <a
                  ...
                  className="w-10 h-10 bg-muted hover:bg-primary/10 rounded-lg flex items-center justify-center transition-colors"
                >
                  <Twitter className="w-5 h-5 text-slate-600 hover:text-primary" />
                </a>
                <a
                  ...
                  className="w-10 h-10 bg-muted hover:bg-primary/10 rounded-lg flex items-center justify-center transition-colors"
                >
                  <Instagram className="w-5 h-5 text-slate-600 hover:text-primary" />
                </a>
                <a
                ...
                <a
                  ...
                  className="w-10 h-10 bg-muted hover:bg-primary/10 rounded-lg flex items-center justify-center transition-colors"
                >
                  <Youtube className="w-5 h-5 text-slate-600 hover:text-primary" />
                </a>
              </div>
              <div className="text-center md:text-right">
                <a
                  href="https://www.facebook.com/TamilComputing/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-slate-600 hover:text-primary transition-colors"
                >
                  Tamil Computing Centre
                </a>
              </div>
            </div>
          </div>
